    ...
    <div className="flex items-center justify-center min-h-screen p-4 bg-light-bg dark:bg-dark-bg">
      <div className="w-full max-w-5xl bg-card-light dark:bg-card-dark rounded-2xl shadow-2xl flex flex-col md:flex-row overflow-hidden">
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12">
          ...
          <p className="text-slate-500 dark:text-slate-400 mb-8">Join the platform to get started.</p>
          <form onSubmit={handleSubmit} className="space-y-4">
             <div>
              <label className="block text-slate-600 dark:text-slate-400 mb-2 font-semibold" htmlFor="name">
                Full Name
              </label>
              <input
                id="name"
            ...
            <div>
              <label className="block text-slate-600 dark:text-slate-400 mb-2 font-semibold" htmlFor="confirm-password">
                Confirm Password
              </label>
              <input
                id="confirm-password"
             ...
             <div>
                <label className="block text-slate-600 dark:text-slate-400 mb-2 font-semibold" htmlFor="role">
                    Role
                </label>
                <select 
                    id="role"
            ...
            <button
                type="submit"
                className="w-full bg-primary text-white font-bold py-3 px-4 rounded-lg hover:bg-primary-hover transition-colors duration-300 shadow-lg hover:shadow-primary/40 mt-4"
            >
                Create Account
            </button>
          </form>
