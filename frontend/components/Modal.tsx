...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children }) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-card-light dark:bg-card-dark text-light-text dark:text-dark-text rounded-2xl shadow-2xl p-6 w-full max-w-lg mx-4 relative animate-scale-in"
